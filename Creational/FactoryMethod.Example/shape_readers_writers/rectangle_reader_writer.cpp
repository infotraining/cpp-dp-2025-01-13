...
namespace 
{
    bool is_registered = SingletonShapeRWFactory::instance().register_creator(make_type_index<Drawing::Rectangle>(), [] { return std::make_unique<Drawing::IO::RectangleReaderWriter>(); });
}
